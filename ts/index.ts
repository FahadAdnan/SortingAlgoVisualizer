...
$(document).ready(function () {
  ...
  if (maxheight && navHeight) bars.maxHeight = maxheight - navHeight-SAFETY_PIXEL_DIFF_HEIGHT;
  else bars.maxHeight = DEFAULT_MAX_HEIGHT;
  
  if(windowWidth && windowWidth < 700) ADJUST_TO_SCREEN_SIZE = 0.6;
