 ...
 */
export function bubbleSort(arrVal: number[]): cssAnimation[] {
  const len = arrVal.length;
  const animationsArr: cssAnimation[] = [];
 ...
 * Space Complexity: O(1)
 */
export function selectionSort(arrVal: number[]): cssAnimation[] {
 ...
 * Space Complexity: O(1)
 */
export function insertionSort(arrVal: number[]): cssAnimation[] {
  const animationsArr: cssAnimation[] = [];
  const len = arrVal.length;
